...
;(function () {
    ...
    FastClick.prototype.onTouchStart = function(event) {
        ...
        if( $(targetElement).hasClass('pub_task_content') || $(targetElement).parents('.pub_task_content') ){
            return false;
        }
        if (deviceIsIOS) {
...
+ function($) {
    ...
    function handleInfiniteScroll2() {
        /*jshint validthis:true */
        ...
        var distance = 50;  
        if (scrollTop >= dheight - wheight - 50) {
            $('.page.page-current').trigger('infinite');
        }

    }
    $.attachInfiniteScroll2 = function(infiniteContent) {
        $(window).on('scroll', handleInfiniteScroll2);
    };
    $.detachInfiniteScroll2 = function(infiniteContent) {
        $(window).off('scroll', handleInfiniteScroll2);
    };

    $.initInfiniteScroll2 = function(pageContainer) {
        
        $.attachInfiniteScroll2();
        
        /*function detachEvents2() {
            $.detachInfiniteScroll2();
            pageContainer.off('pageBeforeRemove', detachEvents2);
        }
        pageContainer.on('pageBeforeRemove', detachEvents2);*/
    };
}(Zepto);
